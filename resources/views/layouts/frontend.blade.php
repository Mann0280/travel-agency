...
<html lang="en">
<head>
    <link rel="icon" href="{{ $site_settings->get('site_favicon') ? asset($site_settings->get('site_favicon')) : ($site_settings->get('site_logo') ? asset($site_settings->get('site_logo')) : asset('favicon.png')) }}">
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ $site_settings->get('site_favicon') ? asset($site_settings->get('site_favicon')) : ($site_settings->get('site_logo') ? asset($site_settings->get('site_logo')) : asset('assets/images/logo1.png')) }}">
    <meta charset="UTF-8">
