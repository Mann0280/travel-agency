...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
            ...
            <p class="text-gray-600">Manage all travel bookings in your system</p>
        </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse ($bookings as $booking)
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{ $booking->package->agency->name ?? 'N/A' }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    @empty
                        <tr>
                            <td colspan="11" class="px-6 py-10 text-center text-gray-500">No bookings found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
...
<script>
                ...
                <div class="border-t pt-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <p class="font-medium">${booking.package?.agency?.name || 'N/A'}</p>
                        </div>
                        <div>
    ...
    function editBooking(id) {
        ...
        const content = `
            <form action="/admin/bookings/${id}" method="POST" class="space-y-6">
                @csrf
    ...
    function updateBookingStatus(id, currentStatus) {
        const booking = bookingsData.find(b => b.id == id);
        const content = `
            <form action="/admin/bookings/${id}" method="POST" class="space-y-4">
                @csrf
                <input type="hidden" name="_method" value="PUT">
                <div>
