...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h1 class="text-3xl font-black text-forest font-poppins">Add New Destination</h1>
            <p class="text-slate mt-1">Create a new destination category</p>
        </div>
    ...
    <!-- Form -->
    <form id="destinationForm" action="{{ route('admin.destinations.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                                ...
                                <select name="category" class="form-select @error('category') border-red-500 @enderror">
                                    ...
                                    <option value="Hill Station" {{ old('category') == 'Hill Station' ? 'selected' : '' }}>Hill Station</option>
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <textarea 
                                ...
                                class="form-textarea @error('meta_description') border-red-500 @enderror">{{ old('meta_description') }}</textarea>
            ...
            <div class="space-y-6">
                ...
                <div class="card">
                    ...
                    <div class="file-upload-area border-2 border-dashed border-forest/30 rounded-xl p-8 text-center cursor-pointer hover:border-forest hover:bg-forest/5 transition-all duration-300" 
                        ...
                        <p class="text-forest font-semibold mb-2">Click to upload or drag and drop</p>
