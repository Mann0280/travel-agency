...
<div class="space-y-6 p-4 md:p-6">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
            ...
            <p class="text-gray-600">Create a new travel package for your portal</p>
        </div>
        <div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div>
                        ...
                        <input type="number" name="rating" class="form-input" min="0" max="5" step="0.1" placeholder="e.g., 4.9" value="{{ old('rating') }}">
                    </div>
                    <div>
                        <label class="form-label">Rating Count</label>
                        <input type="number" name="reviews_count" class="form-input" min="0" placeholder="e.g., 124" value="{{ old('reviews_count') }}">
                    </div>
                    <div>
                    ...
                    <div class="flex items-center">
                        <label class="flex items-center">
                            <input type="checkbox" name="featured" value="1" class="rounded border-gray-300 text-secondary focus:ring-secondary mr-2" {{ old('featured') ? 'checked' : '' }}>
