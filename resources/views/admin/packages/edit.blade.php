    ...
    <input type="hidden" name="price" value="{{ $package->price }}">
                            ...
                            <div class="pt-2 border-t border-gray-100">
                             ...
                             <div class="pt-2 border-t border-gray-100">
                                ...
                                <div id="departureCitiesContainer" class="space-y-3 mb-2">
                                        ...
                                        <div class="flex flex-col gap-2 p-3 bg-gray-50 rounded-lg border border-gray-100 group/city relative">
                                            ...
                                            <div class="grid grid-cols-2 gap-2">
                                                <div class="relative">
                                                    ...
                                                    <input type="text" name="departure_cities[{{ $index }}][city]" class="form-input text-[10px] py-1.5 pl-7" value="{{ $cityData['city'] ?? (is_string($cityData) ? $cityData : '') }}" placeholder="City" required>
                                                </div>
                                                <div class="relative">
                                                    <span class="absolute left-2.5 top-1/2 -translate-y-1/2 text-gray-400 text-[10px]">₹</span>
                                                    <input type="number" name="departure_cities[{{ $index }}][price]" class="form-input text-[10px] py-1.5 pl-6" value="{{ $cityData['price'] ?? 0 }}" placeholder="Price" required min="0">
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
    ...
    function addDepartureCity() {
        ...
        div.innerHTML = `
            ...
            <div class="grid grid-cols-2 gap-2">
                <div class="relative">
                    <span class="absolute left-2.5 top-1/2 -translate-y-1/2 text-gray-400 text-[10px]"><i class="fas fa-plane-departure"></i></span>
                    <input type="text" name="departure_cities[][city]" class="form-input text-[10px] py-1.5 pl-7" placeholder="City" required>
                </div>
                <div class="relative">
                    <span class="absolute left-2.5 top-1/2 -translate-y-1/2 text-gray-400 text-[10px]">₹</span>
